...
and the I<spaceship operator> (C<< <=> >>), nicknamed by Heidi Wall
and popularized by Randal Schwartz.
...
operators either. The perl parser does not specifically recognize them,
...
Perl continues to evolve and improve, and sometimes secret operators fall
...
Slaven Rezić, Lorenzo Taviani, Ferenc Erki, Håkon Hægland,
...
On 2021-03-23, Randal did a re-run of his talk. It's on YouTube,
and the bit about Geneva naming the "diamond" operator is at
L<https://www.youtube.com/watch?v=tE0R51r78sE&t=2664s>.

On 2010-01-04 though, in L<https://perlmonks.org/?node_id=815677>, Randal
claims it was Heidi Wall who helped him name the spaceship operator.

=item *

Post C<< <1994May1.035104.25990@netlabs.com> >> in C<comp.lang.perl>

In 1994, Larry Wall discovers the baby cart and describes it as "a way to
...
On 2005-02-01, José Castro starts the original "secret operators" thread.
...
On 2005-02-01, in the same thread, Alistair McGlinchy describes the
...
On 2005-02-02, Philippe Bruhat uses the word "Venus" to describe C<0+>.

=item *

L<http://www.nntp.perl.org/group/perl.fwp/2006/07/msg3855.html>

On 2006-07-07, Philippe Bruhat names the baby cart operator.

=item *

L<http://www.nntp.perl.org/group/perl.fwp/2006/07/msg3891.html>

On 2006-07-13, Aristotle Pagaltzis explains how the baby cart can be
used to break aliasing.

=item *

L<http://www.perlmonks.com/?node_id=564792>

On 2006-07-31, the Perlmonks post
...
On 2007-11-28, Philippe Bruhat describes the flaming X-Wing secret
operator.
...
On 2007-11-30, Dmitry Karasik describes the screwdriver operators,
and other C<!>-based operators.

=item *

L<https://stackoverflow.com/questions/161872/hidden-features-of-perl>

On 2008-10-02, a Stack Overflow thread discusses "hidden features of Perl",
mentions several secret operations.

=item *

L<https://perlmonks.org/?node_id=773443>

On 2009-06-22, the above Stack Overflow post led to a similar thread
on Perlmonks, which gave particular attention to secret operators.

=item *

L<https://perlmonks.org/?node_id=773791>

On 2009-06-22, in a response to the above post, Andrew Savige produce
a summary of secret operators known at the time.

=item *

L<https://perlmonks.org/?node_id=775629>

On 2009-06-29, another message in the same thread, also by Andrew
Savige, goes into detail over all the names proposed for the baby cart
operator. That message got updated as late as 2021.

=item *

L<http://www.nntp.perl.org/group/perl.golf/2009/06/msg2524.html>

On 2009-06-24, Philippe Bruhat offers a description of the fourth
screwdriver operator (Pozidriv).

=item *

L<https://catonmat.net/secret-perl-operators>

On 2009-11-30, Peter Krumins publishes a blog post about Perl secret
operators, in which he named baby cart the "turtle" operator.

=item *

L<http://www.nntp.perl.org/group/perl.fwp/2012/03/msg4169.html>

On 2012-03-14, Philippe Bruhat proposes a description of the sperm
operator.

=item *

L<https://perlmonks.org/?node_id=959855>

On 2012-03-15, the above post is reported to Perlmonks, which led to a
naming discussion that eventually settled on the name kite as the more
appropriate name for the operator.

=item *

L<https://www.nntp.perl.org/group/perl.perl5.porters/2012/04/msg185203.html>

On 2012-04-02, Philippe Bruhat proposes the newly created L<perlsecret>
manual page for inclusion in the Perl core documenation. It wouldn't be
referenced in the main L<perl> manual page (therefore being an actual
"secret").

After Ricard Signes (the pumpking at the time) stated that "First off, I'm
not including documentation that makes goatse references or sperm jokes.",
Philippe applied a "Safe For Work" patch to remove those words from the
manual page, so as to avoid giving an "opportunity for Perl-haters to
ridicule it."

Its inclusion in the Perl core documenation was eventually rejected by
the pumpking on 2021-06-18. Version 1.000 of this module was published
on CPAN on 2012-06-21.

=item *

L<http://www.nntp.perl.org/group/perl.fwp/2012/04/msg4192.html>

On 2012-04-06, Michael R. Wolf proposes an alternate, family-friendly,
nickname for the goatse operator, with a second order inside joke.
...
understandable alternative, but it turns out Hardy is I<both> the fat and
the tall one.
...
On 2014-09-06, a Perlmonks post by Tye McQueen showed not secret
operators, but funny nicknames to for all the ASCII punctuation marks.
...
The Perl secret operators have been the topic of several presentations
at various conferences, and some of them have been recorded.

=over 4

=item *

L<https://www.youtube.com/watch?v=jPSYSItGZ1c>

On 2012-08-20, during the first lightning talks session of the
YAPC::Europe 2012 conference in Frankfurt, Germany, Philippe Bruhat
presented the perlsecret manual page.

=item *

L<https://www.youtube.com/watch?v=3SfEsW16sAg>

On 2013-09-24, at an AmsterdamX.pm meeting in the Amsterdam Booking.com
offices, Philippe Bruhat ran a 40 minutes presentation that explained
all the secret operators in detail. The abstract of the presentation
was: "Perl is more cryptic than its critics say and more fun than its
fans imagine."

=item *

L<https://www.youtube.com/watch?v=iurBWUFvDCs>

On 2014-08-22, at the YAPC::Europe 2014 conference in Sofia, Bulgaria,
Mihai Pop from Cluj.pm gave a 20 minutes Minions-themed presentation
titled "Perl Secret", that described a selection of Perl secret operators.
