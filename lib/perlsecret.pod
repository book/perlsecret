...
It simply replaces a false scalar by the empty list.
    ...
    # avoid warnings and ", , " in the output
    my $desc = join ', ', map $_ ||(), @list;

Mnemonic: one is tall and one is fat, just like the famous comedy duo.
...
Keith C. Ivey, Michael R. Wolf, Olivier Mengué, Yves Orton
