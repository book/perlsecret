...
parser recognizes them, but in the sense that these Perl programmers
have seen them often enough to recognize them without thinking about
their smaller parts, and eventually add them
to their toolbox.
...
transmitted by a fellow programmer), because they are not explicitely
documented.
