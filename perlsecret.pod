...
However, because unary minus simply chops the initial C<-> from a string,
the spacestation does B<not> numify I<strings starting with a minus>.
...
Aristotle Pagaltzis, Toby Inkster and the Fun With Perl mailing list.
